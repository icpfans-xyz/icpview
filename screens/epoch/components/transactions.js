...
import { timeSince, precise6, dnaFmt, txTypeFmt } from '../../../shared/utils/utils'
...
const Transactions = ({
    ...
    useEffect(() => {
        const fetchData = async (offset) => {
            const transactions = await getTransactions(offset, pageSize)
        ...
        errorMessage
            ...
            : <div className="table-responsive">
                ...
                <button type="button" className="btn btn-small" onClick={() => fetchMore()}>
                    Show more txs ({data.reduce((prev, cur) => prev + (cur ? cur.length : 0), 0)} of{' '}
